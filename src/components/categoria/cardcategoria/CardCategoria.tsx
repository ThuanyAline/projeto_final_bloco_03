...
function CardCategoria({ categoria }: CardCategoriaProps) {
  return (
    <div className="flex flex-col rounded-2xl overflow-hidden justify-between">
      ...
      <p className="text-black p-8 text-3xl bg-white h-full font-semibold">{categoria.nome}</p>

      <div className="text-black flex justify-center gap-4 py-3 bg-indigo-800">
